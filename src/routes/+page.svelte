...
<div class="min-h-screen bg-olive-one selection:bg-green-two md:py-24 md:px-8">
  <main class="mx-auto min-h-screen max-w-none rounded-none bg-cream-four px-5 py-10 outline-none md:min-h-max md:max-w-[60rem] md:rounded-xl md:outline-4 md:outline-offset-8 md:outline-cream-four">
